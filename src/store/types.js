...
export const DEL_ARTICLE = 'DEL_ARTICLE' // 取消文章收藏
export const SET_GOODS = 'SET_GOODS'; // 商品收藏
export const DEL_GOODS = 'DEL_GOODS' // 取消商品收藏

export const SET_ORDERS = 'SET_ORDERS'; // 加入订单
export const DEL_ORDERS = 'DEL_ORDERS' // 删除订单
export const ORDERS_DETAIL = 'ORDERS_DETAIL' // 订单详情
